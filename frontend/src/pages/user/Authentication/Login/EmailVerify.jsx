      ...
      .then((res)=>{
        ...
        if(res.data.mission == "success"){
          ...
          if(location.state.isLogin){
            navigate("/user/reEnterPassword",{state:emailCheck.current});
          } 

          // else {
          //   navigate("/user/profilePic",{state:{email:emailCheck.current}});
          // }
    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-gray-50">
      ...
      >
        <div className="max-w-md w-full space-y-6">
          ...
          >
            Go back to{" "}
            <a href="http://localhost:5173/user/login" className="text-teal-500 hover:underline">
              Login
            </a>
          </p>)
          ...
          >
            To move further <br/> 
            <span className=" underline underline-offset-2">Verify Email Once Again</span> 
          </p>
          )}
